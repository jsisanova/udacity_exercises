...
// After rotation now: onPause, onSaveInstanceState. onStop, onDestroy, onCreate, onStart, onResume.
//Verify that onStop and onDestroy now work on rotate
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         * occurred, we append their name to the TextView.
         *
         ...
         * the ArrayList so we don't get duplicate entries in the TextView. (by pressing RESET LOG
         * it would show me after rotation also the previous Strings ON_STOP & ON_RESTART in ArrayList)
         */
    ...
    protected void onStop() {
        ...
        // TODO (2) Add the ON_STOP String to the front of ArrayList mLifecycleCallbacks
        /*
         * Since any updates to the UI we make after onSaveInstanceState (onStop, onDestroy, etc),
         * we use an ArrayList to track if these lifecycle events had occurred. If any of them have
