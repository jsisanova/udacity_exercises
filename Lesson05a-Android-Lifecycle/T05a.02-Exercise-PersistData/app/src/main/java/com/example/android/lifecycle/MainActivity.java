...
//Now our solution is imperfect -- We're missing onStop and onDestroy, because those states happen after onSaveInstanceState is called .
// When I rotate now phone it shows me: onPause, onSaveInstantState, onCreate, onStart, onResume.
public class MainActivity extends AppCompatActivity {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        // Log and append the lifecycle method name to the TextView
