...
public class NotificationUtils {
    ...
    private static PendingIntent contentIntent(Context context) {
        ...
        // - Takes an unique integer ID for the pending intent (a constant from above)
        // - Takes the intent to open the MainActivity you just created; this is what is triggered when the notification is triggered
    ...
    // returns a Bitmap. This method is necessary to decode a bitmap image needed to be displayed in the notification.
