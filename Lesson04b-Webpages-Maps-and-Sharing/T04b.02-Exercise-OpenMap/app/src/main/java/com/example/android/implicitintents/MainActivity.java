...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenAddressButton(View v) {
        ...
        // Call showMap(), passing in the Uri from the previous step
        showMap(addressUri);
     ...
     *
     * When constructing implicit Intents, you can use either the setData method (as below) or specify the
     * URI as the second parameter of the Intent's constructor (as above).
     *
     * @param geoLocation The Uri representing the location that will be opened in the map
     */
    private void showMap(Uri geoLocation) {
//        Intent intent = new Intent(Intent.ACTION_VIEW, geoLocation);
        // Convert String to geo URI via Uri.parse is also a possibility
