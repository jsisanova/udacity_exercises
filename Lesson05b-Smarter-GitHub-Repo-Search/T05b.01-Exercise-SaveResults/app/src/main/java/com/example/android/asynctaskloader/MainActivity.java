...
public class MainActivity extends AppCompatActivity {
    ...
    @Override
    // TODO (3) Override onSaveInstanceState to persist data across Activity recreation (after rotation...)
    protected void onSaveInstanceState(Bundle outState) {
        // TODO (4) call super.onSaveInstanceState before doing anything else
