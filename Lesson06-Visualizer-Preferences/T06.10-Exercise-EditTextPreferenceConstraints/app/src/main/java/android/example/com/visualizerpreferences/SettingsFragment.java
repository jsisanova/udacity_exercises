...
public class SettingsFragment extends PreferenceFragmentCompat implements
    ...
    public void onCreatePreferences(Bundle bundle, String s) {
        ...
        // TODO (3) Attach the OnPreferenceChangeListener specifically to the EditTextPreference in onCreatePreferences
        // Add the preference listener which checks that the size is correct to the size preference (EditTextPreference)
