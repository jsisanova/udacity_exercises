...
//        onCreate code contains the code for loading the preference, but when you navigate back from an activity,
//        onCreate is not called. The activity was only paused, and not destroyed, so onResume and onStart are called, but nothing else.
        // we have to implement OnSharedPreferenceChangeListener!!!
