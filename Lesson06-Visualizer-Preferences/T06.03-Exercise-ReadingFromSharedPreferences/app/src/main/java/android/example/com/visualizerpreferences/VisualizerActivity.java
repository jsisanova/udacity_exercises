...
public class VisualizerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO (4)
        // we will see the change now only after eg. rotation, as method is called in onCreate
        setupSharedPreferecnes();
        setupPermissions();
    }

    // TODO (1) Change the name of default setup to setupSharedPreferences
    // Get all of the values from shared preferences to set it up - read from share preferences
    private void setupSharedPreferecnes() {
        ...
        // first parameter is key, second default value
